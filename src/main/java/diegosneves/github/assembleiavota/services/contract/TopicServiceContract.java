...
public interface TopicServiceContract {
     ...
     * @throws TopicAttributeException em caso de título inválido, descrição ou duração da sessão de votação.
     */
    TopicCreatedResponse createNewTopic(TopicRequest topicRequest) throws TopicAttributeException;
